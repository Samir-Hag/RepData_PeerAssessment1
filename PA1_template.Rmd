...
```{r spliting_dates_in_columns, echo=TRUE}
...
```{r calculating_total_number_of_steps_per_day, echo=TRUE}
...
```{r Total_number_of_steps_per_day_plot, echo=TRUE}
...
```{r Average number of steps per interval plot}
...
```{r Number of steps per day -imputed ploting, echo=TRUE}
...
```{r Number of steps per interval for weekday and weekend plot, echo=TRUE}
